<nav>
  <div class="nav-inner">
    ...
    <button class="theme-toggle-btn" id="themeToggle" aria-label="Alternar tema" onclick="toggleTheme()">
      ...
      <svg class="icon-moon" width="22" height="22" viewBox="0 0 24 24" fill="#e6b7d3" stroke="#e6b7d3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
    </button>
